...
int main(void)
{
	...
	lsm9ds1_ctx_init_imu(&imu_config.ctx, &hspi4);
	imu_config.accel_range = LSM9DS1_4g;
	imu_config.gyro_range = LSM9DS1_500dps;
	imu_config.imu_odr = LSM9DS1_IMU_119Hz; // in Hz
	...
	lsm9ds1_ctx_init_mag(&mag_config.ctx, &hspi4);
	mag_config.mag_range = LSM9DS1_4Ga;
	mag_config.mag_odr = 50;
